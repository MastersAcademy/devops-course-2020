...
docker run -it --rm --net alex_network -p 9000:4567 -e DB=postgresql:somepass@alex_postgres:5432 -e CHACHE=redis://:somepass@alex_redis:6379/ -v "$PWD":/usr/src/app/ -w /usr/src/app ruby:2.6.0 ruby server.rb
